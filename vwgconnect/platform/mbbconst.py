...
# S-PIN URLs
SPIN_PREFIX = "/api/rolesrights/authorization/v2/vehicles/{VIN}/services/"
SPIN_LOCK = SPIN_PREFIX + "rlu_v1/operations/LOCK/security-pin-auth-requested"
SPIN_UNLOCK = SPIN_PREFIX + "rlu_v1/operations/UNLOCK/security-pin-auth-requested"
SPIN_AUX = SPIN_PREFIX + "rheating_v1/operations/P_QSACT/security-pin-auth-requested"
SPIN_TIMER = SPIN_PREFIX + "timerprogramming_v1/operations/P_SETTINGS_AU/security-pin-auth-requested"
SPIN_CLIMA = SPIN_PREFIX + "rclima_v1/operations/P_START_CLIMA_AU/security-pin-auth-requested"
